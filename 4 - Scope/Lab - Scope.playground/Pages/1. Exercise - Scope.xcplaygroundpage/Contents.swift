...
//print("The value of foo is \(foo)")
print("It will genearte compiler error because foo is local variable and it can not be used outside it's scope.")
...
print("it will compile because x is global variable and can be used outside of its scope. x is defined in global scope and it is modified in local scope of for loop. foo is a local variable and can not be used outside it's scope.")
...
greeting(greeting: nil, name: "Tom")
