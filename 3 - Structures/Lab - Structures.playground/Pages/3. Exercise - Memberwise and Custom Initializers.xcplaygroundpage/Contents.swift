...
let favouriteBook1 = Book(title:"The Aesop Fables",author:"Napolean",pages:200,price:10.0)
print(favouriteBook1.author)
print(favouriteBook1.title)
print(favouriteBook1.price)
print(favouriteBook1.pages)
/*:
...
let laptop1 = Laptop(screenSize: 5, repairCount: 3, yearPurchased: 2020)
let laptop2 = Laptop(screenSize: 6, repairCount: 4, yearPurchased: 2024)
...
let someoneHeight = Height(inches: 65)
