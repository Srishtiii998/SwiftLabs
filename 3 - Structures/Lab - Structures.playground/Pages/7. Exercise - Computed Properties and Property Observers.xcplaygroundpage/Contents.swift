...
var height = Height(heightInInches: 75)
print("Initial height in inches: \(height.heightInInches)")
print("Initial height in centimeters: \(height.heightInCentimeters)")
height.heightInInches = 80
print("Height in inches after change: \(height.heightInInches)")
print("Height in centimeters after change: \(height.heightInCentimeters)")
