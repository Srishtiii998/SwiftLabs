...
let japit = User(name: "japit", age: 19, height: 6.0, weight: 72, activityLevel: 7)
print(japit.name)
print(japit.activityLevel)
print(japit.age)
print(japit.height)
print(japit.weight)
...
struct Distance {
    ...
    init(meter: Int) {
        self.meters = meter
        self.feet = Double(meter) * 3.28084
    }
    
    init(feet: Double) {
        self.feet = feet
        self.meters = Int(feet / 3.28084)
    }
}


let d1 = Distance(meter: 1600)
print(d1.feet)
print(d1.meters)
