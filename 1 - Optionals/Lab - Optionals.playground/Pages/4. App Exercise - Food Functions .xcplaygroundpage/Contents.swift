...
// Test calls
if let breakfast = getMeal("Breakfast") {
    print("Breakfast foods: \(breakfast.food), Calories: \(breakfast.calories)")
} else {
    print("Breakfast not logged yet.")
}

if let dinner = getMeal("Dinner") {
    print("Dinner foods: \(dinner.food), Calories: \(dinner.calories)")
} else {
    print("Dinner not logged yet.")
}
