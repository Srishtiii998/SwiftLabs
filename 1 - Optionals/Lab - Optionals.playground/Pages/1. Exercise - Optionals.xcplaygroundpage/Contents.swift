...
//userAge is nil because the string "34e" contains a non-numeric character 'e'.The Int initializer fails to conver this invalid string to an integer,so it returns nil.")
/*:
