...
if let positiveArea = calculateArea(x: 5.0 , y: 10.0){
    print("Area with positive numbers \(positiveArea)")
} else {
    print("invalid input for positive number.")
}

if let negativeArea = calculateArea(x: -5.0 , y: 10.0){
    print("Area with negative number: \(negativeArea)")
}
else{
    print("Invalid input due to negative number..")
}
...
if let user = createUser() {
    ...
    print("Failed to create user: one or more fields were empty or nil.")
}
