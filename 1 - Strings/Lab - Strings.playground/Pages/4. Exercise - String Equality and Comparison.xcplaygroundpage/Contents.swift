 ...
 */
let nameInCaps = "JAPIT SINGH"
let name = "japit singh"
if nameInCaps==name {
...
if junior.hasSuffix("Jr.") {
    ...
    print("We didn't found the name")
}
...
if textToSearchThrough.lowercased().contains(textToSearchFor) {//we can use lowercased() for the text that we are searching for but didnt use as it was already small
    print("I found it!")
}else{
